        ...
        *,
        ...
        out: Dict[str, Any] = {
            ...
            "geometry": {
                ...
                "front_overhang_m": geom.bumper_l,
                "rear_overhang_m": geom.bumper_l,
                "safety_margin_m": float(getattr(geom, "safety_margin_m", 0.08) or 0.08),
                ...
                "collision_model_broad_phase": "bounding_radius",
                "collision_model_narrow_phase": "footprint_polygon_samples",
                "swept_sampling_spatial_m": 0.08,
                "swept_sampling_angular_deg": 5.0,
                "radius_role": "approximation_broad_phase_only",
                "track_width_unavailable": True,
                "wheelbase_unavailable": True,
            },
            "radar": {
                "front_near": round(front_near, 3),
                "rear_near": round(rear_near, 3),
